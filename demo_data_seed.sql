...
-- For this script, we'll use: 'demo_user_sarah_chen'
...
BEGIN
    -- Get medication IDs
    SELECT id INTO med_metformin_id FROM medications WHERE user_id = 'demo_user_sarah_chen' AND generic_name = 'Metformin HCl';
    SELECT id INTO med_lisinopril_id FROM medications WHERE user_id = 'demo_user_sarah_chen' AND generic_name = 'Lisinopril';
    SELECT id INTO med_levothyroxine_id FROM medications WHERE user_id = 'demo_user_sarah_chen' AND generic_name = 'Levothyroxine Sodium';
    SELECT id INTO sup_vitamin_d_id FROM supplements WHERE user_id = 'demo_user_sarah_chen' AND supplement_name = 'Vitamin D3';
    SELECT id INTO sup_omega3_id FROM supplements WHERE user_id = 'demo_user_sarah_chen' AND supplement_name = 'Omega-3 Fish Oil';
    SELECT id INTO sup_magnesium_id FROM supplements WHERE user_id = 'demo_user_sarah_chen' AND supplement_name = 'Magnesium Glycinate';
...
('demo_user_sarah_chen', 'breakfast', 'Blueberry Muffin & Latte', NOW() - INTERVAL '30 days' + INTERVAL '8 hours', 520, 8, 72, 22, 2, 38, 420, '[{"name": "Blueberry muffin", "quantity": "1 large", "calories": 380}, {"name": "Vanilla latte (whole milk)", "quantity": "16 oz", "calories": 140}]'::jsonb, 'Grabbed at coffee shop on way to work'),
('demo_user_sarah_chen', 'lunch', 'Chicken Teriyaki Bowl with White Rice', NOW() - INTERVAL '30 days' + INTERVAL '12 hours 30 minutes', 780, 32, 112, 18, 3, 28, 1680, '[{"name": "White rice", "quantity": "2 cups", "calories": 410}, {"name": "Teriyaki chicken", "quantity": "6 oz", "calories": 280}, {"name": "Stir-fried vegetables", "quantity": "1 cup", "calories": 90}]'::jsonb, 'Takeout lunch at desk, very high sodium'),
('demo_user_sarah_chen', 'dinner', 'Pasta Alfredo with Garlic Bread', NOW() - INTERVAL '30 days' + INTERVAL '19 hours', 1050, 28, 135, 42, 5, 12, 1540, '[{"name": "Fettuccine alfredo", "quantity": "2.5 cups", "calories": 850}, {"name": "Garlic bread", "quantity": "2 slices", "calories": 200}]'::jsonb, 'Too tired to cook, ate comfort food. Felt bloated after.'),
('demo_user_sarah_chen', 'snack', 'Chocolate Chip Cookies', NOW() - INTERVAL '30 days' + INTERVAL '15 hours', 280, 3, 38, 14, 1, 24, 180, '[{"name": "Chocolate chip cookies", "quantity": "3 medium", "calories": 280}]'::jsonb, 'Afternoon energy crash, reached for cookies');

-- Day 2
INSERT INTO meal_logs (user_id, meal_type, meal_name, timestamp, total_calories, total_protein_g, total_carbs_g, total_fat_g, total_fiber_g, total_sugar_g, total_sodium_mg, food_items, user_notes) VALUES
('demo_user_sarah_chen', 'breakfast', 'Skipped Breakfast', NOW() - INTERVAL '29 days' + INTERVAL '8 hours', 0, 0, 0, 0, 0, 0, 0, '[]'::jsonb, 'Rushed morning, no time. Felt shaky by 10am.'),
('demo_user_sarah_chen', 'lunch', 'Turkey Sub Sandwich & Chips', NOW() - INTERVAL '29 days' + INTERVAL '13 hours', 820, 38, 95, 32, 5, 14, 1920, '[{"name": "12-inch turkey sub", "quantity": "1", "calories": 650}, {"name": "Potato chips", "quantity": "1.5 oz", "calories": 160}, {"name": "Diet Coke", "quantity": "12 oz", "calories": 0}]'::jsonb, 'Deli lunch, very salty'),
('demo_user_sarah_chen', 'snack', 'Granola Bar & Coffee', NOW() - INTERVAL '29 days' + INTERVAL '15 hours 30 minutes', 210, 4, 32, 8, 2, 18, 120, '[{"name": "Granola bar", "quantity": "1 bar", "calories": 190}, {"name": "Coffee with cream", "quantity": "8 oz", "calories": 20}]'::jsonb, NULL),
('demo_user_sarah_chen', 'dinner', 'Frozen Pizza', NOW() - INTERVAL '29 days' + INTERVAL '20 hours', 940, 36, 108, 38, 4, 12, 2180, '[{"name": "Frozen pepperoni pizza", "quantity": "3/4 pizza", "calories": 940}]'::jsonb, 'Exhausted from work, quick frozen dinner');

-- Day 3
INSERT INTO meal_logs (user_id, meal_type, meal_name, timestamp, total_calories, total_protein_g, total_carbs_g, total_fat_g, total_fiber_g, total_sugar_g, total_sodium_mg, food_items, user_notes) VALUES
('demo_user_sarah_chen', 'breakfast', 'Bagel with Cream Cheese', NOW() - INTERVAL '28 days' + INTERVAL '7 hours 30 minutes', 450, 14, 68, 14, 3, 8, 620, '[{"name": "Plain bagel", "quantity": "1 large", "calories": 320}, {"name": "Cream cheese", "quantity": "2 tbsp", "calories": 100}, {"name": "Orange juice", "quantity": "8 oz", "calories": 110}]'::jsonb, NULL),
('demo_user_sarah_chen', 'lunch', 'Chinese Takeout - Orange Chicken', NOW() - INTERVAL '28 days' + INTERVAL '12 hours', 920, 28, 128, 32, 3, 42, 1840, '[{"name": "Orange chicken", "quantity": "2 cups", "calories": 720}, {"name": "Fried rice", "quantity": "1.5 cups", "calories": 350}]'::jsonb, 'Team lunch, very sugary sauce'),
('demo_user_sarah_chen', 'snack', 'Vending Machine Crackers', NOW() - INTERVAL '28 days' + INTERVAL '15 hours', 190, 3, 24, 9, 1, 3, 280, '[{"name": "Cheese crackers", "quantity": "1 pack", "calories": 190}]'::jsonb, NULL),
('demo_user_sarah_chen', 'dinner', 'Burger and Fries (Takeout)', NOW() - INTERVAL '28 days' + INTERVAL '19 hours 30 minutes', 1180, 42, 118, 58, 6, 18, 1560, '[{"name": "Cheeseburger", "quantity": "1", "calories": 750}, {"name": "French fries", "quantity": "medium", "calories": 380}, {"name": "Diet soda", "quantity": "16 oz", "calories": 0}]'::jsonb, 'Didn''t feel like cooking');

-- Day 4
INSERT INTO meal_logs (user_id, meal_type, meal_name, timestamp, total_calories, total_protein_g, total_carbs_g, total_fat_g, total_fiber_g, total_sugar_g, total_sodium_mg, food_items, user_notes) VALUES
('demo_user_sarah_chen', 'breakfast', 'Instant Oatmeal with Brown Sugar', NOW() - INTERVAL '27 days' + INTERVAL '8 hours', 320, 8, 58, 6, 4, 22, 340, '[{"name": "Instant oatmeal (maple brown sugar)", "quantity": "2 packets", "calories": 320}]'::jsonb, 'Quick breakfast'),
('demo_user_sarah_chen', 'lunch', 'Chicken Caesar Salad', NOW() - INTERVAL '27 days' + INTERVAL '12 hours 30 minutes', 680, 38, 32, 42, 4, 6, 1240, '[{"name": "Caesar salad with chicken", "quantity": "large", "calories": 680}]'::jsonb, 'Tried to eat healthier but dressing was very heavy'),
('demo_user_sarah_chen', 'snack', 'Apple', NOW() - INTERVAL '27 days' + INTERVAL '15 hours', 95, 0, 25, 0, 4, 19, 2, '[{"name": "Medium apple", "quantity": "1", "calories": 95}]'::jsonb, 'Good choice!'),
('demo_user_sarah_chen', 'dinner', 'Spaghetti with Meatballs', NOW() - INTERVAL '27 days' + INTERVAL '19 hours', 850, 38, 98, 32, 6, 14, 1180, '[{"name": "Spaghetti with marinara", "quantity": "2 cups", "calories": 480}, {"name": "Meatballs", "quantity": "4", "calories": 320}, {"name": "Parmesan cheese", "quantity": "2 tbsp", "calories": 50}]'::jsonb, NULL);

-- Day 5
INSERT INTO meal_logs (user_id, meal_type, meal_name, timestamp, total_calories, total_protein_g, total_carbs_g, total_fat_g, total_fiber_g, total_sugar_g, total_sodium_mg, food_items, user_notes) VALUES
('demo_user_sarah_chen', 'breakfast', 'Breakfast Sandwich (Fast Food)', NOW() - INTERVAL '26 days' + INTERVAL '7 hours 45 minutes', 520, 22, 42, 28, 2, 6, 1140, '[{"name": "Sausage egg cheese biscuit", "quantity": "1", "calories": 520}]'::jsonb, 'Grabbed on way to early meeting'),
('demo_user_sarah_chen', 'lunch', 'Chicken Quesadilla', NOW() - INTERVAL '26 days' + INTERVAL '13 hours', 780, 36, 68, 38, 4, 6, 1520, '[{"name": "Chicken quesadilla", "quantity": "1 large", "calories": 780}]'::jsonb, 'Lunch meeting catering'),
('demo_user_sarah_chen', 'snack', 'Trail Mix', NOW() - INTERVAL '26 days' + INTERVAL '16 hours', 280, 8, 28, 16, 4, 18, 95, '[{"name": "Trail mix with M&Ms", "quantity": "1/2 cup", "calories": 280}]'::jsonb, NULL),
('demo_user_sarah_chen', 'dinner', 'Rotisserie Chicken with Mac & Cheese', NOW() - INTERVAL '26 days' + INTERVAL '20 hours', 820, 48, 72, 32, 3, 8, 1420, '[{"name": "Rotisserie chicken breast", "quantity": "6 oz", "calories": 280}, {"name": "Mac and cheese", "quantity": "1.5 cups", "calories": 540}]'::jsonb, 'Store-bought rotisserie, easier than cooking');

-- Day 6 (Saturday)
INSERT INTO meal_logs (user_id, meal_type, meal_name, timestamp, total_calories, total_protein_g, total_carbs_g, total_fat_g, total_fiber_g, total_sugar_g, total_sodium_mg, food_items, user_notes) VALUES
('demo_user_sarah_chen', 'breakfast', 'Pancakes with Syrup', NOW() - INTERVAL '25 days' + INTERVAL '9 hours', 680, 12, 112, 18, 3, 48, 820, '[{"name": "Buttermilk pancakes", "quantity": "3 large", "calories": 510}, {"name": "Maple syrup", "quantity": "4 tbsp", "calories": 210}, {"name": "Butter", "quantity": "1 tbsp", "calories": 100}]'::jsonb, 'Weekend breakfast'),
('demo_user_sarah_chen', 'lunch', 'Leftover Pizza', NOW() - INTERVAL '25 days' + INTERVAL '13 hours 30 minutes', 620, 24, 72, 25, 3, 8, 1450, '[{"name": "Frozen pizza leftovers", "quantity": "1/2 pizza", "calories": 620}]'::jsonb, NULL),
('demo_user_sarah_chen', 'snack', 'Ice Cream', NOW() - INTERVAL '25 days' + INTERVAL '16 hours', 340, 5, 42, 16, 0, 36, 75, '[{"name": "Vanilla ice cream", "quantity": "1 cup", "calories": 340}]'::jsonb, 'Weekend treat'),
('demo_user_sarah_chen', 'dinner', 'Restaurant Italian - Lasagna', NOW() - INTERVAL '25 days' + INTERVAL '19 hours 30 minutes', 1050, 42, 95, 52, 5, 18, 1880, '[{"name": "Meat lasagna", "quantity": "large serving", "calories": 850}, {"name": "Garlic bread", "quantity": "2 slices", "calories": 200}]'::jsonb, 'Dinner out with friends. Felt very full and bloated.');

-- Day 7 (Sunday)
INSERT INTO meal_logs (user_id, meal_type, meal_name, timestamp, total_calories, total_protein_g, total_carbs_g, total_fat_g, total_fiber_g, total_sugar_g, total_sodium_mg, food_items, user_notes) VALUES
('demo_user_sarah_chen', 'breakfast', 'Brunch - Eggs Benedict', NOW() - INTERVAL '24 days' + INTERVAL '10 hours', 720, 28, 48, 42, 2, 6, 1240, '[{"name": "Eggs benedict", "quantity": "2", "calories": 720}]'::jsonb, 'Sunday brunch'),
('demo_user_sarah_chen', 'lunch', 'Light Snacking', NOW() - INTERVAL '24 days' + INTERVAL '14 hours', 380, 12, 48, 14, 3, 18, 420, '[{"name": "Crackers and cheese", "quantity": "1 serving", "calories": 280}, {"name": "Grapes", "quantity": "1 cup", "calories": 100}]'::jsonb, 'Not very hungry after big brunch'),
('demo_user_sarah_chen', 'dinner', 'Homemade Tacos', NOW() - INTERVAL '24 days' + INTERVAL '18 hours 30 minutes', 680, 32, 62, 28, 8, 6, 980, '[{"name": "Ground beef tacos", "quantity": "3 tacos", "calories": 680}]'::jsonb, 'Actually cooked! Used lean beef and added lettuce, tomatoes.');
