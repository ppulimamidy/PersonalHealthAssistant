...
class ErrorHandlingMiddleware:
    ...
    def _handle_http_exception(
        ...
        # If detail is a dict (e.g. usage gate), return it directly as the response
    ...
    def _handle_validation_error(
        ...
        error_response = ErrorResponseModel(
            ...
            details={"request_id": request_id, "validation_errors": error_details},
        )
    ...
    def _handle_database_error(
        ...
        error_response = ErrorResponseModel(
            ...
            details={"request_id": request_id, "database_error": str(exc)},
        )
    ...
    def _handle_jwt_error(self, exc: JWTError, request_id: str) -> JSONResponse:
        ...
        error_response = ErrorResponseModel(
            ...
            details={"request_id": request_id, "jwt_error": str(exc)},
        )
...
def create_error_response(
    ...
    error_response = ErrorResponseModel(
        success=False, error=message, error_code=error_code, details=details or {}
    )
