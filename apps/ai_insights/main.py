...
from apps.ai_insights.api import insights_router, recommendations_router, health_scores_router, patterns_router, agents_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:8080"],  # Configure appropriately for production
