...
from sqlalchemy import Column, String, DateTime, JSON, Text, Boolean, Integer, ForeignKey, Index
...
class EpicFHIRConnection(Base):
    ...
    environment: Mapped[str] = mapped_column(String(50), nullable=False, default="sandbox")
    ...
    # Relationships
    observations: Mapped[List["EpicFHIRObservation"]] = relationship("EpicFHIRObservation", back_populates="connection")
    diagnostic_reports: Mapped[List["EpicFHIRDiagnosticReport"]] = relationship("EpicFHIRDiagnosticReport", back_populates="connection")
    documents: Mapped[List["EpicFHIRDocument"]] = relationship("EpicFHIRDocument", back_populates="connection")
    imaging_studies: Mapped[List["EpicFHIRImagingStudy"]] = relationship("EpicFHIRImagingStudy", back_populates="connection")
...
class EpicFHIRObservation(Base):
    ...
    id: Mapped[UUID] = mapped_column(PGUUID(as_uuid=True), primary_key=True, default=uuid4)
    connection_id: Mapped[UUID] = mapped_column(PGUUID(as_uuid=True), ForeignKey("epic_fhir_connections.id"), nullable=False)
    
    # FHIR resource information
    fhir_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    resource_type: Mapped[str] = mapped_column(String(50), nullable=False, default="Observation")
    ...
    # Timing
    effective_datetime: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    ...
    reference_range_high: Mapped[Optional[float]] = mapped_column(Integer, nullable=True)
    ...
    # Relationships
    connection: Mapped["EpicFHIRConnection"] = relationship("EpicFHIRConnection", back_populates="observations")
...
class EpicFHIRDiagnosticReport(Base):
    ...
    # FHIR resource information
    fhir_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    resource_type: Mapped[str] = mapped_column(String(50), nullable=False, default="DiagnosticReport")
    ...
    # Relationships
    connection: Mapped["EpicFHIRConnection"] = relationship("EpicFHIRConnection", back_populates="diagnostic_reports")
...
class EpicFHIRDocument(Base):
    ...
    # FHIR resource information
    fhir_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    resource_type: Mapped[str] = mapped_column(String(50), nullable=False, default="DocumentReference")
    ...
    # Relationships
    connection: Mapped["EpicFHIRConnection"] = relationship("EpicFHIRConnection", back_populates="documents")
...
class EpicFHIRImagingStudy(Base):
    ...
    # FHIR resource information
    fhir_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    resource_type: Mapped[str] = mapped_column(String(50), nullable=False, default="ImagingStudy")
    ...
    # Relationships
    connection: Mapped["EpicFHIRConnection"] = relationship("EpicFHIRConnection", back_populates="imaging_studies")
...
class EpicFHIRSyncLog(Base):
    ...
    # Sync details
    sync_type: Mapped[str] = mapped_column(String(50), nullable=False)  # 'full', 'incremental', 'specific'
    resource_type: Mapped[str] = mapped_column(String(50), nullable=False)  # 'Observation', 'DiagnosticReport', etc.
