...
from ..schemas.clinical_reports import (
...
from ..services.clinical_reports_service import clinical_reports_service
...
async def get_report_templates(
    ...
    try:
        templates = clinical_reports_service.get_report_templates(
            db=db,
...
async def get_report_categories(
    ...
    try:
        categories = clinical_reports_service.get_report_categories(
            db=db,
            user_id=current_user["user_id"],
...
async def get_report_statistics(
    ...
    try:
        stats = clinical_reports_service.get_report_statistics(
            db=db,
            user_id=current_user["user_id"],
...
@router.get("/{report_id:uuid}", response_model=ClinicalReportResponse)
...
@router.put("/{report_id:uuid}", response_model=ClinicalReportResponse)
...
@router.get("/{report_id:uuid}/versions", response_model=ReportVersionListResponse)
...
@router.get("/{report_id:uuid}/audit-logs", response_model=ReportAuditLogListResponse)
