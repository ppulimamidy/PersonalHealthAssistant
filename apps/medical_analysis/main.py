...
print(f"[DEBUG] SERVICE_PORT: {settings.SERVICE_PORT}")
print(f"[DEBUG] HOST: {settings.HOST}")
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        from apps.medical_analysis.services.medical_analysis_service import MedicalAnalysisService
        ...
        "capabilities": {
            "analysis_types": {
                "diagnosis": {
                    ...
                    "supported_domains": ["cardiology", "dermatology", "neurology", "general"]
                },
                "prognosis": {
